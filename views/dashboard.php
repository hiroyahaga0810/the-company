...
//create an object
$user = new User;
$user_list = $user->getAllUsers($_SESSION['id']);
                ...
                <?php
                    ...
                    while ($user_details = $user_list->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-user.php?id=<?= $user_details['id'] ?>" class="btn btn-outline-warning">
                                <i class="fas fa-pencil-alt"> </i> </a>

                                <a href="delete-user.php?id=<?= $user_details['id'] ?>" class="btn btn-outline-danger">
